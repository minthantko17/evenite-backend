...
describe('UserValidationService - validateUserExists', () => {
  ...
  it('UT-4-001-02: should throw UserNotFoundException with message when user not found', async () => {
...
describe('UserValidationService - validateParticipantProfileNotExists', () => {
  ...
  it('UT-4-002-02: should throw ProfileAlreadyExistsException with message when participant profile already exists', async () => {
...
describe('UserValidationService - validateOrganizerProfileNotExists', () => {
  ...
  it('UT-4-003-02: should throw ProfileAlreadyExistsException with message when organizer profile already exists', async () => {
...
describe('UserValidationService - validateParticipantProfileData', () => {
  ...
  it('UT-4-005-01: should resolve without throwing when full valid dto is provided', () => {
    expect(() =>
  ...
  it('UT-4-005-02: should resolve without throwing when only firstName is provided', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Su Su',
      }),
  ...
  it('UT-4-005-03: should resolve without throwing when contactEmail is empty string', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Chaiwat',
        contactEmail: '',
  ...
  it('UT-4-005-04: should resolve without throwing when optional fields are undefined', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Napat',
  ...
  it('UT-4-005-05: should throw NameEmptyException when firstName is empty string', () => {
    const call = () =>
  ...
  it('UT-4-005-06: should throw NameEmptyException when firstName is whitespace only', () => {
    const call = () =>
      service.validateParticipantProfileData({ firstName: '    ' });
    expect(call).toThrow(NameEmptyException);
    expect(call).toThrow('First name cannot be empty.');
  ...
  it('UT-4-005-07: should throw NameEmptyException when firstName is undefined', () => {
    const call = () =>
  ...
  it('UT-4-005-08: should throw InvalidMailException when contactEmail has invalid format', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Somsak',
  ...
  it('UT-4-005-09: should throw InvalidMailException when contactEmail is missing @ symbol', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Nattapong',
  ...
  it('UT-4-005-10: should throw InvalidPreferencesException when personal preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Arisa',
        preferences: {
  ...
  it('UT-4-005-11: should throw InvalidPreferencesException when event preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Thanida',
        preferences: {
  ...
  it('UT-4-005-12: should throw InvalidPreferencesException when language preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Wanchai',
        preferences: {
  ...
  it('UT-4-005-13: should throw InvalidPreferencesException when personalOther exceeds max length', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Kanya',
        preferences: {
...
describe('UserValidationService - validateOrganizerProfileData', () => {
  ...
  it('UT-4-006-01: should resolve without throwing when full valid dto is provided', () => {
    expect(() =>
  ...
  it('UT-4-006-02: should resolve without throwing when only name is provided', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'SE Department',
      }),
  ...
  it('UT-4-006-03: should resolve without throwing when contactEmail is empty string', () => {
    expect(() =>
      service.validateOrganizerProfileData({
  ...
  it('UT-4-006-04: should resolve without throwing when externalUrl is empty string', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'Science Club',
        externalUrl: '',
  ...
  it('UT-4-006-05: should resolve without throwing when optional fields are undefined', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'Art Society',
        contactEmail: undefined,
  ...
  it('UT-4-006-06: should throw NameEmptyException when name is empty string', () => {
    const call = () =>
  ...
  it('UT-4-006-07: should throw NameEmptyException when name is whitespace only', () => {
    const call = () =>
      service.validateOrganizerProfileData({ name: '   ' });
    expect(call).toThrow(NameEmptyException);
    expect(call).toThrow('Organizer name cannot be empty.');
  ...
  it('UT-4-006-08: should throw NameEmptyException when name is undefined', () => {
    const call = () =>
  ...
  it('UT-4-006-09: should throw InvalidMailException when contactEmail has invalid format', () => {
    const call = () =>
      service.validateOrganizerProfileData({
        name: 'Music Club',
  ...
  it('UT-4-006-10: should throw InvalidUrlException when externalUrl has invalid format', () => {
    const call = () =>
      service.validateOrganizerProfileData({
        name: 'Sports Club',
  ...
  it('UT-4-006-11: should throw InvalidUrlException when externalUrl is missing protocol', () => {
    const call = () =>
      service.validateOrganizerProfileData({
        name: 'Coding Club',
...
describe('UserValidationService - checkRoleTransition', () => {
  ...
  it('UT-4-004-01: should resolve without throwing when switching from null to PARTICIPANT', () => {
    expect(() =>
      service.checkRoleTransition(null, Role.PARTICIPANT),
    ).not.toThrow();
  });

  it('UT-4-004-02: should resolve without throwing when switching from null to ORGANIZER', () => {
    expect(() =>
      service.checkRoleTransition(null, Role.ORGANIZER),
    ).not.toThrow();
  });

  it('UT-4-004-03: should resolve without throwing when switching from PARTICIPANT to ORGANIZER', () => {
    expect(() =>
      service.checkRoleTransition(Role.PARTICIPANT, Role.ORGANIZER),
    ).not.toThrow();
  });

  it('UT-4-004-04: should resolve without throwing when switching from ORGANIZER to PARTICIPANT', () => {
    expect(() =>
      service.checkRoleTransition(Role.ORGANIZER, Role.PARTICIPANT),
    ).not.toThrow();
  });

  it('UT-4-004-05: should throw InvalidRoleTransitionException with message when switching from PARTICIPANT to PARTICIPANT', () => {
    const call = () =>
  ...
  it('UT-4-004-06: should throw InvalidRoleTransitionException with message when switching from ORGANIZER to ORGANIZER', () => {
    const call = () =>

...
describe('UserValidationService - validateParticipantProfileData', () => {
  ...
  it('UT-M058-01: should resolve without throwing when full valid dto is provided', () => {
    expect(() =>
  ...
  it('UT-M058-02: should resolve without throwing when only firstName is provided', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Su Su',
      }),
  ...
  it('UT-M058-03: should resolve without throwing when contactEmail is empty string', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Chaiwat',
        contactEmail: '',
  ...
  it('UT-M058-04: should resolve without throwing when optional fields are undefined', () => {
    expect(() =>
      service.validateParticipantProfileData({
        firstName: 'Napat',
  ...
  it('UT-M058-05: should throw NameEmptyException when firstName is empty string', () => {
    const call = () =>
  ...
  it('UT-M058-06: should throw NameEmptyException when firstName is whitespace only', () => {
    const call = () =>
      service.validateParticipantProfileData({ firstName: '    ' });
    expect(call).toThrow(NameEmptyException);
    expect(call).toThrow('First name cannot be empty.');
  ...
  it('UT-M058-07: should throw NameEmptyException when firstName is undefined', () => {
    const call = () =>
  ...
  it('UT-M058-08: should throw InvalidMailException when contactEmail has invalid format', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Somsak',
  ...
  it('UT-M058-09: should throw InvalidMailException when contactEmail is missing @ symbol', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Nattapong',
  ...
  it('UT-M058-10: should throw InvalidPreferencesException when personal preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Arisa',
        preferences: {
  ...
  it('UT-M058-11: should throw InvalidPreferencesException when event preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Thanida',
        preferences: {
  ...
  it('UT-M058-12: should throw InvalidPreferencesException when language preference contains invalid value', () => {
    const call = () =>
      service.validateParticipantProfileData({
        firstName: 'Wanchai',
        preferences: {
...
describe('UserValidationService - validateOrganizerProfileData', () => {
  ...
  it('UT-M059-02: should resolve without throwing when only name is provided', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'SE Department',
      }),
  ...
  it('UT-M059-04: should resolve without throwing when externalUrl is empty string', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'Science Club',
        externalUrl: '',
  ...
  it('UT-M059-05: should resolve without throwing when optional fields are undefined', () => {
    expect(() =>
      service.validateOrganizerProfileData({
        name: 'Art Society',
        contactEmail: undefined,
  ...
  it('UT-M059-06: should throw NameEmptyException when name is empty string', () => {
    const call = () =>
  ...
  it('UT-M059-09: should throw InvalidMailException when contactEmail has invalid format', () => {
    const call = () =>
      service.validateOrganizerProfileData({
        name: 'Music Club',
...
describe('UserValidationService - checkRoleTransition', () => {
  ...
  it('UT-M061-01: should resolve without throwing when switching from null to PARTICIPANT', () => {
    expect(() =>
      service.checkRoleTransition(null, Role.PARTICIPANT),
    ).not.toThrow();
  });

  it('UT-M061-02: should resolve without throwing when switching from null to ORGANIZER', () => {
    expect(() =>
      service.checkRoleTransition(null, Role.ORGANIZER),
    ).not.toThrow();
  });

  it('UT-M061-03: should resolve without throwing when switching from PARTICIPANT to ORGANIZER', () => {
    expect(() =>
      service.checkRoleTransition(Role.PARTICIPANT, Role.ORGANIZER),
    ).not.toThrow();
  });

  it('UT-M061-04: should resolve without throwing when switching from ORGANIZER to PARTICIPANT', () => {
    expect(() =>
      service.checkRoleTransition(Role.ORGANIZER, Role.PARTICIPANT),
    ).not.toThrow();
  });

  it('UT-M061-05: should throw InvalidRoleTransitionException with message when switching from PARTICIPANT to PARTICIPANT', () => {
    const call = () =>
  ...
  it('UT-M061-06: should throw InvalidRoleTransitionException with message when switching from ORGANIZER to ORGANIZER', () => {
    const call = () =>

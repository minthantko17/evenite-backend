...
describe('FormValidationService - validateFormTypeNotDuplicated', () => {
  ...
  it('UT-M038-01: should resolve without throwing when REGISTRATION form does not yet exist', async () => {
    const input = {
    ...
    // console.log('[UT-M038-01] Input :', input);
    // console.log('[UT-M038-01] Expected : resolves undefined');
    // console.log('[UT-M038-01] Actual :', result);
  ...
  it('UT-M038-02: should throw FormAlreadyExistsException when REGISTRATION form already exists', async () => {
    const input = {
      eventId: 'e1000000-0000-0000-0000-000000000001',
      type: FormType.REGISTRATION,
    };
  ...
  it('UT-M038-03: should throw FormAlreadyExistsException when FEEDBACK form already exists', async () => {
    const input = {
...
describe('FormValidationService - validateFormNotLocked', () => {
  ...
  it('UT-M039-01: should resolve without throwing when event status is DRAFT', async () => {
  ...
  it('UT-M039-02: should throw FormNotFoundException when form not found', async () => {
  ...
  it('UT-M039-03: should throw FormLockedException when event status is PUBLISHED', async () => {
    const input = { formId: 'f1000000-0000-0000-0000-000000000001' };
  ...
  it('UT-M039-04: should throw FormLockedException when event status is ONGOING', async () => {
    const input = { formId: 'f1000000-0000-0000-0000-000000000001' };
  ...
  it('UT-M039-05: should throw FormLockedException when event status is CONCLUDED', async () => {
    const input = { formId: 'f1000000-0000-0000-0000-000000000001' };
  ...
  it('UT-M039-06: should throw FormLockedException when event status is CANCELLED', async () => {
    const input = { formId: 'f1000000-0000-0000-0000-000000000001' };
...
describe('FormValidationService - validateNoResponsesExist', () => {
  ...
  it('UT-M040-01: should resolve without throwing when no responses exist', async () => {
    const input = { formId: 'f1000000-0000-0000-0000-000000000001' };
  ...
  it('UT-M040-02: should throw FormAlreadyHasResponsesException when exactly 1 response exists', async () => {
  ...
  it('UT-M040-03: should throw FormAlreadyHasResponsesException when multiple responses exist', async () => {
...
describe('FormValidationService - validateFormFields', () => {
  ...
  it('UT-M041-01: should not throw when fields array is empty', () => {
    const input = { fields: [] };
    // console.log('[UT-M041-01] Input :', input);
    // console.log('[UT-M041-01] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });

  it('UT-M041-02: should not throw when TEXT field is valid', () => {
    const input = {
      fields: [
        {
          type: FieldType.TEXT,
    ...
    // console.log('[UT-M041-02] Input :', input);
    // console.log('[UT-M041-02] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });

  it('UT-M041-03: should not throw when CHOICE field has exactly 2 options', () => {
    const input = {
      fields: [
        {
    ...
    // console.log('[UT-M041-03] Input :', input);
    // console.log('[UT-M041-03] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });

  it('UT-M041-04: should not throw when CHECKBOX field has exactly 2 options', () => {
    const input = {
      fields: [
        {
    ...
    // console.log('[UT-M041-04] Input :', input);
    // console.log('[UT-M041-04] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });

  it('UT-M041-05: should not throw when NUMBER, RATING, TEXTAREA, DATE fields have no options', () => {
    const input = {
      fields: [
        {
    ...
    // console.log('[UT-M041-05] Input :', input);
    // console.log('[UT-M041-05] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });

  it('UT-M041-06: should throw FormFieldInvalidException when field has empty string label', () => {
    const input = {
      fields: [
    ...
    // console.log('[UT-M041-06] Input :', input);
    // console.log('[UT-M041-06] Expected :', expectedMessage);
  ...
  it('UT-M041-07: should throw FormFieldInvalidException when field has whitespace-only label', () => {
    const input = {
      fields: [
        { type: FieldType.TEXT, label: '   ', isRequired: false, options: [] },
      ],
    ...
    const expectedMessage = 'Field at index 0: label is required.';
    // console.log('[UT-M041-07] Input :', input);
    // console.log('[UT-M041-07] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-08: should throw FormFieldInvalidException when field has null label', () => {
    const input = {
      fields: [
        {
          type: FieldType.TEXT,
    ...
    const expectedMessage = 'Field at index 0: label is required.';
    // console.log('[UT-M041-08] Input :', input);
    // console.log('[UT-M041-08] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-09: should throw FormFieldInvalidException when CHOICE field has 0 options', () => {
    const input = {
      fields: [
        {
          type: FieldType.CHOICE,
    ...
    // console.log('[UT-M041-09] Input :', input);
    // console.log('[UT-M041-09] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-10: should throw FormFieldInvalidException when CHOICE field has exactly 1 option', () => {
    const input = {
      fields: [
        {
          type: FieldType.CHOICE,
    ...
    const expectedMessage =
      'Field at index 0: at least two options are required for CHOICE type.';
    // console.log('[UT-M041-10] Input :', input);
    // console.log('[UT-M041-10] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-11: should throw FormFieldInvalidException when CHECKBOX field has 0 options', () => {
    const input = {
      fields: [
        {
          type: FieldType.CHECKBOX,
    ...
    // console.log('[UT-M041-11] Input :', input);
    // console.log('[UT-M041-11] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-12: should throw FormFieldInvalidException when CHECKBOX field has exactly 1 option', () => {
    const input = {
      fields: [
        {
          type: FieldType.CHECKBOX,
    ...
    const expectedMessage =
      'Field at index 0: at least two options are required for CHECKBOX type.';
    // console.log('[UT-M041-12] Input :', input);
    // console.log('[UT-M041-12] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-13: should throw FormFieldInvalidException at index 0 when first of multiple fields has empty label', () => {
    const input = {
      fields: [
        { type: FieldType.TEXT, label: '', isRequired: false, options: [] },
        {
    ...
    const expectedMessage = 'Field at index 0: label is required.';
    // console.log('[UT-M041-13] Input :', input);
    // console.log('[UT-M041-13] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-14: should throw FormFieldInvalidException at index 1 when second field has invalid options', () => {
    const input = {
      fields: [
        {
          type: FieldType.TEXT,
    ...
    // console.log('[UT-M041-14] Input :', input);
    // console.log('[UT-M041-14] Expected :', expectedMessage);
    expect(() => service.validateFormFields(input.fields)).toThrow(
      FormFieldInvalidException,
    );
    expect(() => service.validateFormFields(input.fields)).toThrow(
  ...
  it('UT-M041-15: should not throw when field type is an unrecognized value', () => {
    const input = {
      fields: [
        {
    ...
    // console.log('[UT-M041-15] Input :', input);
    // console.log('[UT-M041-15] Expected : no throw');
    expect(() => service.validateFormFields(input.fields)).not.toThrow();
  });
});
